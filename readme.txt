...
προσθέσει νέο χρήστη μέσω του κουμπιού create new user. οταν κάποιος συνδεθεί σαν user μπορεί να κάνει αίτηση για αποζημίωση βάζοντας τα στοιχεία του
στην συνέχεια μπορεί να προβεί σε επεξεργασία των στοιχείων του και να κάνει αίτηση για ρόλο Inspector.